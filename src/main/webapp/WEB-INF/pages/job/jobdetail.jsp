			...
			<div class="col-md-9">
				<div class="panel panel-white border-strong">
					...
					<div class="panel-heading">
						<c:forEach items="${projectdetails}" var="record" varStatus="status">
					...
					<div class="row" id=create_proposal>
						...
						<div
							class="col-md-2>
                               ...
                               <c:forEach items="${project}" var="record" varStatus="status">
                                <div class="col-md-4 pull-right">
                                <a href="${pageContext.request.contextPath}/proposal?token=${record.token}"> Proposal</a>
                                </div> 
                                </c:forEach> 
                        </div>                      
                             <!-- Feature Set Section -->        
                            ...
                            <section>
                             <c:forEach items="${availableroles}" var="record" varStatus="status">
                             <c:if test="${status.first}">
