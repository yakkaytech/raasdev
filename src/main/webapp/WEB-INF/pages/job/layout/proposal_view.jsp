...
<body>
			...
			<div>
				...
				<div>
				  <c:forEach items="${teamstatus}" var="record">
					<button id="add_member" value="${record.statusflag}" >+Add People</button>
					</c:forEach>
				</div>
			</div>
		</div>
	...
	<c:forEach items="${viewdetail}" var="record" varStatus="stat">
		<c:if test="${stat.first}">
			<div class="col-lg-5" id="teamviewdetails">
				...
				<div class="row" align="center">
					...
					<div class="col-xs-1">
						<span>
						<c:forEach items="${teamstatus}" var="rec">
						<button type="button" value="${rec.statusflag}"
								class="btn button-border-primary btn-circle"
				...
				<br>
					<div class="form-group">
						<label class="col-xs-3 control-label" for="name">Task
							Owner:</label> <label class="col-xs-9 control-label" for="name"
							id="task_owner">${record.firstname}-${record.lastname}</label>
					</div>
					<br>
				<br>
				<br>
					<div class="form-group">
						<label class="col-xs-3 control-label" for="name">Task
							Cost:</label> <label class="col-xs-9 control-label" for="name"
							id="task_cost">${record.cost}</label>
					</div>
					<br>
				<br>
				<br>
				...
				<div class="form-group">
					<label class="col-xs-3 control-label" for="name">Estimated
						...
						id="team_estimated_hours">${record.estimated_hours}</label>
				</div>
				<br>
				<br>
				<br>
