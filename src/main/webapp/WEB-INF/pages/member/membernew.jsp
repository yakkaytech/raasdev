...
<spring:url
	...
	var="css8" />
<spring:url value="/resources/common/resource/js/form_wizard.js"
	var="js2" />
<spring:url value="/resources/common/resource/js/select2.min.js"
	var="js6" />
<spring:url value="/resources/common/resource/js/jquery.steps.js"
	var="js4" />
<spring:url value="/resources/common/resource/js/jasny-bootstrap.js"
	var="js3" />
<spring:url value="/resources/common/resource/js/moment.min.js"
	var="js7" />
							...
							<div class="col-md-12">
								...
								<form id="wizard-validation" name="wizard-validation">
											...
											<div class="form-group">
												...
												<div>
													<table class="table table-striped table-bordered" id="root"
														...
														<tbody>
															<c:forEach items="${role}" var="record">
																<tr>
									...
									<section>
										...
										<div class="form-group">
											<label for="state"> State/Zone: </label><br> <select
												name="select2_StateZone" id="select2_StateZone"
												class="dropstate">
												<c:forEach items="${zonedata}" var="record">
										...
										<div class="form-group">
											<label for="country"> Please select your timezone.
												This would help us to find work within your timezone: </label><br>
											<select name="select2_TimeZone" id="select2_TimeZone">
									...
									<section>
										...
										<div class="form-group">
											<input id="user" name="user" type="text"  style="display:none" value="${user}" />
										</div>
										<div class="form-group">
											<input id="user_id" name="user_id" type="text"  style="display:none"
												value="${user_id}" />
										</div>
									</section>
								</form>
