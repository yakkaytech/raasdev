            ...
            <div class="col-lg-8">
                        ...
                        <div class="panel panel-default" style="border:1">
                            <div class="panel-heading border-light">
                                 <c:forEach items="${project}" var="rec">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                   <div class="col-lg-6"> <c:forEach items="${project}" var="rec">
                                    <p>${rec.des}</p>
                                </c:forEach>
                                   ...
                                   <c:forEach items="${project}" var="rec">
                                    <a href="${pageContext.request.contextPath}/sampleproposal/${rec.token}" class="btn btn-info pull-right" role="button">
