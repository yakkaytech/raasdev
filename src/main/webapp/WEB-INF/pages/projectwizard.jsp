							...
							<div class="row">
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6">
                                        <div class="form-group">
                                          ...
                                          <select id="projecttype" class="form-control required" name="select">
                                              <option value=""></option>
                                              ...
                                              <option value="7">Application Maintenance</option>
                                              <option value="8">Business Intelligence</option>
                                              <option value="8">Maintenance</option>
                                          </select>
                                      </div>
                                      <div class="form-group">
                                          <label for="projectname">Project Name *</label>
                                          <input id="projectname" name="projectName" type="text" placeholder="Project Name" class="form-control required">
                                      </div>
                                      <div class="form-group">
                                          <label for="description">Project Description *</label>
                                          <textarea class="form-control" rows="4" id="description" name="textarea" placeholder="Description" ></textarea>
                                       </div>
                                       <p>(*) Mandatory</p>
                                     </div>
                                     <div class="col-lg-1">
                                      ...
                                      <div class="col-lg-5">
                                        ...
                                        <div class="box">
                                            <div class="box-icon box-icon1">
                                                <i class="livicon icon1" data-name="user" data-size="55" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                            </div>
                                            <div class="info">
                                                <h3 class="primary text-center">Add a Project Planner 
                                            </h3>
                                                <p>Project planners can help plan, organize and control the project. The planners can also help decompose project into smaller tasks, assist in identifying right project team, verify and sign-off the tasks to complete. Depends on your size and compexity, you may add a planner to the team. If you are not sure at this time, you can always add later. 
                                            </div>
								...
								<h1 class="hidden-xs">Technology</h1>
				                  ...
				                  <div class="row">
                                      <div class="col-lg-6">
                                        <div class="form-group">
                                          <label for="projecttype">Primary technology stack *</label><br>
                                          <select id="projecttype" class="form-control required" name="select" style ="width:100%" >
                                              <option value=""></option>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <textarea class="form-control" rows="4" data-role="tagsinput" placeholder="technology" class="form-control required" ></textarea>
                                       </div>
                                       <p>(*) Mandatory</p>
                                     </div>
                                     <div class="col-lg-1">
                                      ...
                                      <div class="col-lg-5">
                                        ...
                                        <div class="box">
                                            ...
                                            <div class="info">
                                                <h3 class="primary text-center">Add an Cloud Architect 
                                            </h3>
                                                <p>The cloud architect has demonstrated proficiency in the technical architecture that underlies cloud platform and cloud based IT resources and solutions, and has mastered the hands-on application of design patterns, principles, and practices used to engineer and evolve environments.
                                            </div>
                                ...
                                <section>
                                   <div class="row" style="height: 160px;">
									...
									<div class="form-group">
                                      ...
                                      <div class="form-group">
												<label for="timezone"> Any timelines?
												</label> <select name="timezone" id="timezone" class="dropstate">
													  <option value=""></option>
                                    ...
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                          <textarea class="form-control" rows="10" data-role="tagsinput" placeholder="scrollable terms and condition goes here" class="form-control required" read-only ></textarea>
                                       </div>
