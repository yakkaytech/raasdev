...
public interface user_service {
	...
	void insertskill(int user_id, skill[] skills, skill skill) throws Exception;

	List<wrapper> getuserrole(int userid)throws Exception;

	List<wrapper> getuserSkills(int userid)throws Exception;
