...
public class wrapper {
	...
	private String priority_cde_name;
	...
	private int proposal_task_count;
	private int estimated_hrscount;
	...
	private List<memberRequest_vo> member_req;
	...
	public List<memberRequest_vo> getMember_req() {
		return member_req;
	}

	public void setMember_req(List<memberRequest_vo> member_req) {
		this.member_req = member_req;
	}
	...
	public int getProposal_task_count() {
		return proposal_task_count;
	}

	public void setProposal_task_count(int proposal_task_count) {
		this.proposal_task_count = proposal_task_count;
	}

	public int getEstimated_hrscount() {
		return estimated_hrscount;
	}

	public void setEstimated_hrscount(int estimated_hrscount) {
		this.estimated_hrscount = estimated_hrscount;
	}
	...
	public String getPriority_cde_name() {
		return priority_cde_name;
	}

	public void setPriority_cde_name(String priority_cde_name) {
		this.priority_cde_name = priority_cde_name;
	}
