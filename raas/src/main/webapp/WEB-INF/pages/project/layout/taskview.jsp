		...
		<c:if test="${stat.first}">
			<div class="col-lg-5" id="teamviewdetails">
				...
				<div class="row" align="center">
					...
					<div class="col-xs-1">
						<span><button type="button"
								class="btn button-border-primary btn-circle" id="edit_task">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="edittaskdetails" name="edittaskdetails" method="POST"
						action="${pageContext.request.contextPath}/crt/editviewtask"
								...
								<div class="form-group">
									<div class="col-md-9">
										<input id="taskid" name="task_id" type="text"
											class="form-control" /> <input id="projectid"
											name="project_id" type="text" class="form-control"
											style="display: none;" /> <input id="task_grp_id"
											name="task_group_id" type="text" class="form-control" /> <br>
									</div>
								</div>
								<!-- /input-group -->
								<!-- Form actions -->
