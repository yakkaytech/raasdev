...
<spring:url value="resources/common/regis.js"
	var="js1" />
	...
	<div class="container">
		...
		<div class="row">
			<div class="box">
				...
				<form id="f" action="${pageContext.request.contextPath}/register" method="post">
					<!-- CSRF Token -->
					...
					<div class="form-group">
					<input type="submit" class="btn btn-primary" value="Create Work" id="sub" name="sub">				 
					
					<input type="submit" class="btn btn-primary" id="sub1" name="sub1" value="Ready for work">
