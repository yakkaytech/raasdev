			...
			<nav class=" navbar navbar-default container">
				<div class="navbar-header">
					<button type="button" class="navbar-toggle collapsed"
						...
						<span><a href="#">_<i class="livicon"
								data-name="responsive-menu" data-size="25" data-loop="true"
                ...
                <ul class="nav navbar-nav navbar-center">-->
					...
					<!-- by raj -->
					<ul class="nav navbar-nav navbar-center">
						<li class="dropdown-toggle"><a href="{{ route('home') }}">
								Raaspool</a></li>
						...
						<li
							class="dropdown {!! (Request::is('aboutus') || Request::is('timeline') || Request::is('faq') || Request::is('blank_page')  ? 'active' : '') !!}"><a
						...
						<li class="dropdown-toggle"><a
							href="${pageContext.request.contextPath}/jobs">Jobs</a></li>

						<!-- end of raj -->

						<li
							{!!(Request::is('blog') || Request::is('blogitem/*') ? 'class="active"' : '') !!}><a
							href="{{ URL::to('blog') }}"> How it works</a></li>
						<li class="dropdown-toggle"><a href="{{ URL::to('login') }}">CREATE
								PROJECT</a></li>
						<li class="dropdown-toggle"><a
							href="{{ URL::to('register') }}">JOIN THE TEAM</a></li>
						<li {{ (Request::is('my-account') ? 'class=active
							' : '') }} class="dropdown-toggle"><a
							href="{{ URL::to('my-account') }}">My Account</a></li>
						<%
                         String username=(String) session.getAttribute("user");
                         if(username==null){
                        	 %>
						<li class="dropdown-toggle" id="login"><a
							href="${pageContext.request.contextPath}/login">LOGIN</a></li>
						<% }else{
                            	 %>
						<li class="dropdown-toggle" id="logout"><a
