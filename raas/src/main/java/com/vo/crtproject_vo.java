...
=======
	...
	@Override
	public String toString() {
		return "crtproject_vo [project_type=" + project_type + ", project_name=" + project_name + ", skill="
				+ skill + ",names="+names+", quantity=" + quantity +",country="+ country +",zone="+ zone +", timezone=" + timezone 	+ ", checkboxes=" + checkboxes + "]";
	}
