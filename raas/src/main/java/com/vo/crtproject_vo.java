...
public class crtproject_vo {
	...
	private String skill_other_name;
	...
	public String getSkill_other_name() {
		return skill_other_name;
	}

	public void setSkill_other_name(String skill_other_name) {
		this.skill_other_name = skill_other_name;
	}
