...
<body>
	...
	<div><jsp:include page='${pageContext.request.contextPath}/crt/projectheader'>
	<jsp:param name="articleId" value=""/>
	</jsp:include></div>
	<div><%@include file="layout/projectheader.jsp"%></div>
	<div class="container">
		...
		<section class="content">
			<div class="row">
						...
						<div>
							...
							<ul class="nav nav-sidebar" id="taskgroupid">
								<c:forEach items="${taskgroup}" var="record">
									<li value="${record.task_group_id}"
										id="${record.task_group_id}"><a href="#"><span>${record.task_group_name}</span>
											<span class="badge left">${record.tasks_cnt_pergp}</span><span style="display:none;">${record.project_id}</span></a></li>
								</c:forEach>
							</ul>
							</div>
						</div>
				...
				<div class="col-lg-9">
						...
						<div class="row">
							...
							<div class="col-lg-3 pull-right">
								<button type="submit" class="btn btn-primary"
									data-toggle="modal" data-target="#editModal">Delete
									Group</button>
							</div>
							 <div class="col-lg-3 pull-right">
								<button type="submit" class="btn btn-primary"
							...
							<div class="col-lg-3 pull-right">
								<button type="submit" class="btn btn-primary"
									data-toggle="modal" data-target="#addTaskModal">Create
									Task</button>
							</div>
					...
					<!-- Task list begin -->
					<div class="row">
					<form id="viewtasks" name="viewtasks" method="POST" action="${pageContext.request.contextPath}/crt/taskdetail"> 
						<table class="table table-striped table-bordered"
							...
							<tbody id="taskdetailbody" 
								...
								<c:forEach items="${taskdetails}" var="record" >
									...
									<tr id="${record.task_id}" class="taskrow"  data-href="taskdetail">
										...
										<td align="center" id="size_code"> ${record.task_size_code}</td>
										<td align="center">
											<button type="button"
					...
					<div class="modal fade" id="editModal" tabindex="-1" role="dialog"
						aria-labelledby="myModalLabel" aria-hidden="true">
						<form:form  id="edittaskgp" action="${pageContext.request.contextPath}/crt/savetaskgrp" 
						method="POST" >
								...
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal"
											aria-hidden="true">&times;</button>
										<h4 class="modal-title" id="myModalLabel">
											<i class="fa fa-plus"></i> Edit Group -  <label id="taskgroupname"></label>
										</h4>
										<div class="col-md-9">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<form:form id="savetaskdetails" name="registration" enctype="multipart/form-data"
										...
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<select class="form-control" name="task_type_id" id="tasktypename">
                                        ...
                                        <div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="name1" name="name" type="text"
														placeholder="Enter Task ID" class="form-control">
													<span id="getlink" style="color: red"></span><br>
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="name">
													Est.StartDate</label>
												<div class="col-md-9">
													<input type="date" id="datepicker" data-role="date" data-inline="true" onclick="dateselect()">
												</div>
											</div>
											&nbsp;&nbsp;&nbsp;&nbsp;
											<!--  Est.EndDate -->
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													...
													<div class="input-group">
														<input type="file" name="file" id="new-event" class="form-control"
					...
					<!-- <div class="modal fade" id="editTaskModal" tabindex="-1"
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<!--  <form class="form-horizontal" action="#" method="post"> -->
								<!-- 	<form id="edittaskdetails" name="registration"
										action="${pageContext.request.contextPath}/crt/detailtasks"
										method="POST">
										<fieldset>
											<!-- Task Type input-->
									<!-- 		<div class="form-group">
											...
											<!-- Name input-->
											<!--  <div class="form-group">
												<label class="col-md-3 control-label" for="name">Task Name *</label>
										...
										<!--  	<div class="form-group">
												...
												<select class="form-control" id="sizecode"
													 ...
													 <span id="getsizeid" style="color: red"></span><br>
											</div>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<!--  	<div class="form-group">
												...
												<div class="col-md-9">
													<input id="editname1" name="name" type="text"
														placeholder="Enter Task ID" class="form-control">
													<span id="getlinkid" style="color: red"></span><br>
												</div>
											</div>
									...
									<!--  		<div class="form-group">
										...
										<!--  	</div>
                                             ...
                                             <div class="col-md-9">
												<textarea  name="task_id" id="taskid" style="display: none;"></textarea>
											</div> 
											  
											
											<div class="col-md-9">
												<textarea  name="task_group_id"
													id="taskgroupIde" style="display: none;"></textarea>
											</div>
