...
<link href="http://code.jquery.com/ui/1.10.4/themes/ui-lightness/jquery-ui.css"
 ...
 <spring:url value="/resources/common/vendors/wizard/jquery-steps/css/wizard.css" var="css1" />
<spring:url value="/resources/common/vendors/wizard/jquery-steps/css/jquery.steps.css" var="css2" />
<spring:url value="/resources/common/css/pages/wizard.css" var="css3" />	
<spring:url value="/resources/common/css/pages/formelements.css" var="css4" />
<spring:url value="/resources/common/vendors/slider/bootstrap-slider.min.css" var="css5" />
<spring:url value= "/resources/common/vendors/select2/select2.min.css" var="css6" />
<spring:url value="/resources/common/css/pages/formelements.css" var="css7" />
<spring:url value="/resources/common/vendors/tags/bootstrap-tagsinput.css" var="css8" />
<spring:url value="/resources/common/css/bootstrap.min.css" var="css10" />	

<spring:url value="/resources/common/css/frontend/custom.css" var="css9" />	
	

	
<spring:url value= "/resources/common/vendors/daterangepicker/moment.min.js"
	var="js1" />
<spring:url value= "/resources/common/vendors/wizard/jquery-steps/js/jquery.steps.js"
	var="js2" />
<spring:url value= "/resources/common/vendors/wizard/jquery-steps/js/jquery.validate.min.js"
	var="js3" />	
<spring:url value= "/resources/common/js/pages/form_wizard.js"
	var="js4" />
	<spring:url value= "/resources/common/js/pages/form_wizard.js"
	var="js5" />
<spring:url value= "/resources/common/vendors/jasny-bootstrap/js/jasny-bootstrap.js"
	var="js6" />
<spring:url value="/resources/common/vendors/tags/dist/bootstrap-tagsinput.min.js"
	var="js7" />
...
<spring:url value="/resources/common/vendors/gallery/fancy_box/jquery.fancybox.css" var="css12" />	
 <spring:url value="/resources/common/vendors/gallery/fancy_box/helpers/jquery.fancybox-buttons.css" var="css13" />
<spring:url value="/resources/common/vendors/gallery/fancy_box/helpers/jquery.fancybox-thumbs.css" var="css14" />	 		
<spring:url value="/resources/common/css/frontend/news.css" var="css15" />	 			
<spring:url value="/resources/common/vendors/font-awesome/css/font-awesome.min.css" var="css16" />	 		
<spring:url value="/resources/common/css/frontend/blog.css" var="css17" />	 		
                               ...
                               <section>
									...
									<div class="form-group">
                                     ...
                                     <div class="form-group" id="topskillgroup" >
                                       <input type="text" class="form-control" name="topskill" id="topskill" value="JSP,PHP,JAVA,MYSQL" data-role="tagsinput" placeholder="Enter one skill" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <table class="table table-striped table-bordered" id="table1">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="col-md-2 text-center"><input type="checkbox" name="checkboxes" id="checkboxes-0" value="1"></td>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <tr>
                                                       <td class="col-md-2 text-center"><input type="checkbox" name="checkboxes" id="checkboxes-0" value="2"></td>
                                                       ...
                                                       <tr>
                                                       <td class="col-md-2 text-center"><input type="checkbox" name="checkboxes" id="checkboxes-0" value="3"></td>
                                                       ...
                                                       <tr>
                                                       <td class="col-md-2 text-center"><input type="checkbox" name="checkboxes" id="checkboxes-0" value="4"></td>
                                                      ...
                                                      <tr>
                                                       <td class="col-md-2 text-center"><input type="checkbox" name="checkboxes" id="checkboxes-0" value="5"></td>
                                                       ...
                                                       <tr>
                                                       <td class="col-md-2 text-center"><input type="checkbox" name="checkboxes" id="checkboxes-0" value="6"></td>
                                                       <td>UX designer</td>
                              ...
                              <section>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Rate per hour ($):</label><br>
                                            <div>
                                                <input id="ex6" name="rate" type="text"/>
                                            </div>
                                    </div>
                                   <div class="form-group">
